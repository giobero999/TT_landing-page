...
<head>
  ...
  <link rel="stylesheet" href="css/bootstrap.min.css?rev=@@hash" media="screen" title="no title" charset="utf-8">
  <link rel="stylesheet" href="css/bundle.css?rev=@@hash" media="screen" title="no title" charset="utf-8">
  <link rel="stylesheet" href="css/main.css?rev=@@hash" media="screen" title="no title" charset="utf-8">
  <link rel="stylesheet" href="css/stylesheet.css?rev=@@hash" media="screen" title="no title" charset="utf-8">
    ...
    <?php include('careers.php'); ?>
      ...
      <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
        ...
        <nav id="mobile_menu_content">
          <a href="#home" class="translate" key="home">Home</a>
          <a href="#more_info" class="translate" key="services">Services</a>
          <a href="#feature3" class="translate" key="privilegies">Advantages</a>
          <a href="#about_video" class="translate" key="coming_soon">Software</a>
          <!-- <a href="#screenshots" >Screenshots</a> -->
          <!--  <a href="#pricing" >Pricing</a>
                <a href="#team" >Team</a> -->
          <!--  <a href="#cta_download" >Download</a> -->
          <a href="#contact" class="translate" key="contact">Contacts</a>
          <a href="#scala" key="career" class="translate" data-toggle="modal" data-target="#myModal">Join us</a>
        </nav>
      </div>
      ...
      <div id="preloader_container">
        ...
        <header id="menu_bar" class="menu_bar">
          <div class="container">
            ...
            <nav class="menu_bar_navigation">
              <ul>
                <li class="visible-lg visible-md"><a href="#more_info" class="go_to_overview translate" key="services">SERVICES</a></li>
                <li class="visible-lg visible-md"><a href="#feature3" class="translate" key="privilegies">ADVANTAGES</a></li>
                <li class="visible-lg visible-md"><a href="#about_video" class="translate" key="coming_soon">Software</a></li>
                <li class="visible-lg visible-md"><a href="#contact" class="translate" key="contact">CONTACTS</a></li>
                ...
                <li class="visible-lg visible-md "><a  onclick="javascript:location.href='http://taxitube.io/blog'"><button type="button" class="btn btn-warning blog-menu translate"  key="blog">BLOG</button></a></li>
                <li class="visible-lg visible-md " style="margin-right:25px;">
                  <a href="#scala" data-toggle="modal" id="career-menu" data-target="#myModal">
                    <button type="button" key="career" class="btn btn-warning career-menu translate">JOIN US</button>
                  </a>
                </li>
        ...
        <section id="more_info" class="subsection background_color1">
          <div class="row menu_bar-waypoint" data-animate-down="menu_bar-show" data-animate-up="menu_bar-hide">
          </div>
          <div class="container">
            <!-- INTRO -->
            <div class="row services" style="margin-top:50px">
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 align-center ">
                <div class="feature_content">
                  ...
                  <p class="translate" key="creative">Creative, modern and mobile broadcasting in the streets of Tbilisi</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 align-center">
                <div class="feature_content">
                  <div class="iconbox_icon icon_rounded"><i class="fa fa-users fa-sm"></i></div>
                  <p class="translate" key="audiens">Reach your target audience on a location and time basis</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 align-center">
                <div class="feature_content">
                  <div class="iconbox_icon icon_rounded"><i class="fa fa-bar-chart fa-sm"></i></div>
                  <p class="translate" key="statistic">Evaluate the efficacy of the message based upon our bulletproof statistical data</p>
                </div>
              </div>
            </div>
            <div class="row " style="border-bottom: solid 0px rgba(0,0,0,0.1); margin-bottom:4px; padding-bottom: 60px;">
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 align-center ">
                <div class="feature_content">
                  ...
                  <p class="translate" key="budget">Upload an advertisement and manage your marketing budget with ease</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 align-center">
                <div class="feature_content">
                  <div class="iconbox_icon icon_rounded"><i class="fa fa-calendar fa-sm"></i></div>
                  <p class="translate" key="real_time">Manage Advertising Campaigns in real-time</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 align-center">
                <div class="feature_content">
                  <div class="iconbox_icon icon_rounded"><i class="fa fa-life-ring fa-sm"></i></div>
                  <p class="translate" key="online">Get continual online support</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row feature_box_center" id="feature3" style="border-bottom: solid 0px rgba(0,0,0,0.1);">
              <div class="container" style="padding-top: 3rem;">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center more_info_anim1" >
                  <h3 class="translate three-in-one" key="privilegies-text">3 in 1 INTEGRATED MARKETING CHANNEL:</h3>
                  <b class="translate three-in-one" key="privilegies-bold" style="font-family:roboto; color:#CE5759;letter-spacing: 1px;">OUTDOOR DIGITAL MOBILE</b>
                </div>
              </div>
                ...
                <div class="row">
                    ...
                    <div class="feature_content privilegies">
                      <ul>
                        <li class="mobile-font">
                          <h6 class="translate" key="screen">Display:</h6>
                          <p class="translate" key="privilegies1">Enriched brand with vivid colours</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12 more_info_anim8">
                    <div class="feature_content privilegies">
                      <ul>
                        <li>
                          <h6 class="translate" key="view">Visibility:</h6>
                          <p class="translate" key="privilegies3">As luminous during the day as it is during the night</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12 more_info_anim8">
                    <div class="feature_content privilegies">
                      <ul>
                        <li>
                          <h6 class="translate" key="targeting">Geo-fencing:</h6>
                          <p class="translate" key="privilegies4">Audience targeting by area, district and even street</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12 more_info_anim9">
                    <div class="feature_content privilegies">
                      <ul>
                        <li>
                          <h6 class="translate" key="moving">On The Go:</h6>
                          <p class="translate" key="privilegies2">Broadcasting in time and space</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12 more_info_anim10">
                    <div class="feature_content privilegies">
                      <ul>
                        <li>
                          <h6 class="translate" key="real_timing">Pay As You Go:</h6>
                          <p class="translate" key="privilegies5">Seamless and highly accurate payment-processing</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-4 col-md-12 col-lg-12 more_info_anim10">
                    <div class="feature_content privilegies">
                      <ul>
                        <li>
                          <h6 class="translate" key="campagnes">Campaigns:</h6>
                          <p class="translate" key="privilegies6">Multi-layered brand stories and targeted messages based on time/event</p>
                        </li>
                      </ul>
                    </div>
                  </div>
        ...
        <section id="about_video" class="subsection background_color1">
          <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center about_video_anim1 ">
              <div class="intro">
                <h3 class="translate" key="coming_soon">Coming Soon...</h3>
              ...
              <div class="screen-information">
                ...
                <div class="row information">
                  <div id="information1">
                    ...
                    <p class="information-text translate" key="info-text1">Account creation and user registration</p>
                  </div>
                  <div id="information2">
                    <span class="screen-number">2</span>
                    <span class="av-image-hotspot-pulse"></span>
                    <p class="information-text2 translate" key="info-text2">Advertising campaign creation and managment</p>
                  </div>
                  <div id="information3">
                    <span class="screen-number">3</span>
                    <span class="av-image-hotspot-pulse"></span>
                    <p class="information-text3 translate" key="info-text3">Advertising editorial and image upload and editing</p>
                  </div>
                  <div id="information4">
                    <span class="screen-number">4</span>
                    <span class="av-image-hotspot-pulse"></span>
                    <p class="information-text4 translate" key="info-text4">Budget planning and control</p>
                  </div>
                  <div id="information5">
                    <span class="screen-number">5</span>
                    <span class="av-image-hotspot-pulse"></span>
                    <p class="information-text5 translate" key="info-text5">Accessibility of continually updated statistical data</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 align-center about_video_anim3">
                <div class="feature_content">
                  ...
                  <p class="translate" key="info-text1">Account creation and user registration</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 align-center about_video_anim4">
                <div class="feature_content">
                  ...
                  <p class="translate" key="info-text2">Advertising campaign creation and managment</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 align-center about_video_anim5">
                <div class="feature_content">
                  ...
                  <p class="translate" key="info-text3">Advertising editorial and image upload and editing</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 align-center about_video_anim5">
                <div class="feature_content">
                  ...
                  <p class="translate" key="info-text4">Budget planning and control</p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 align-center about_video_anim5">
                <div class="feature_content">
                  ...
                  <p class="translate" key="info-text5">Accessibility of continually updated statistical data</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 contact_form_container contact_anim1">
                <h3 class="translate" key="contact_us">Contact Us</h3>
                <p></p>
                <!-- Contact Form -->
                ...
                <form action="send_mail.php" id="contact-form" method="post" autocomplete="off">
                  <div class="contact_form">
                    <div class="input-field">
                      ...
                      <label for="first_name" class="translate" key="contact_name">Name</label>
                    </div>
                    <div class="input-field">
                      <input id="contact_email" type="email" name="email" required>
                      <label for="contact_email" class="translate" key="contact_email">Email</label>
                    </div>
                    <div class="input-field">
                      <textarea class="materialize-textarea" name="message" required></textarea>
                      <label class="translate" key="contact_text">Message</label>
                    </div>
                  </div>
                  ...
                  <button class="btn waves-effect btn-sm waves-light  ladda-button" data-style="expand-left" type="submit" data-spinner-color="#fff" name="submit">
                    <span class="ladda-label translate" key="contact_send">Send</span>
                  </button>
                </form>
                <!-- Message container -->
              </div>
              <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 contact_anim2">
                <h3 class="translate" key="contact_info">Contact Information</h3>
                <p></p>
                <ul class="icon_list">
                  <li>
                    <div class="icon_small float-left"></div>
                    <h6 class="translate" key="contact_city"><i class="fa fa-map-marker fa-lg"> &nbsp;</i>Tbilisi, #36 Ksani str.</h6>
                  </li>
                  <li>
                    <div class="icon_small float-left"></div>
      ...
      <script src="js/modernizr.custom.js?rev=@@hash"></script>
      <!-- jQuery -->
      <script src="js/jquery-2.1.3.min.js?rev=@@hash"></script>
      <!-- JavaScript plugins comes here -->
      <script src="js/functions.js?rev=@@hash"></script>
      <!-- Waypoints -->
      <script src="js/waypoints.min.js?rev=@@hash"></script>
      <!-- Materialize -->
      <script src="js/materialize.js?rev=@@hash"></script>
      <!-- Lightbox/Modalbox -->
      <script src="js/nivo-lightbox.min.js?rev=@@hash"></script>
      <!-- Owl Carousel -->
      <script src="js/owl.carousel.js?rev=@@hash"></script>
      <!-- Main Js file -->
      <script src="js/main.js?rev=@@hash"></script>
      <!-- nice scroll -->
      <script src="js/jquery.nicescroll.js?rev=@@hash"></script>
      <!-- sendin email loader -->
      <script src="js/spin.min.js?rev=@@hash"></script>
      <script src="js/ladda.min.js?rev=@@hash"></script>
      <!-- car logo silder -->
