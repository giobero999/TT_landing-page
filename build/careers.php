...
<p>An unique opportunity to work in a small yet extremely talented team and build a software from zero: using cutting edge and hip technologies, frameworks, and tools. You will work on innovative projects from the day one.</p>
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#scala" aria-controls="scala"  role="tab" data-toggle="tab">Senior/Junior Scala Backend Developer</a></li>
            <li role="presentation"><a href="#ios" aria-controls="ios" role="tab" data-toggle="tab">Senior/Junior Front-end and IOS Developer</a></li>
            <li role="presentation"><a href="#designer" aria-controls="designer"role="tab" data-toggle="tab">Senior/Junior UI/UX and Product Designer</a></li>
          </ul>
        <!-- Tab panes -->
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="scala">
              ...
              <div class="careers-share-button" >
                <div class="fb-share-button" style="vertical-align:none !important" data-href="http://taxitube.io/scala.php" data-layout="button"></div>
                <div class="twitter-share-button">
                  <a onClick="window.open('http://twitter.com/intent/tweet?status=<?php echo $twitterTitle;?>', 'sharer', 'toolbar=0,status=0,width=548,height=325');" target="_parent" href="javascript: void(0)">
                    <i class="fa fa-twitter"></i>&nbsp;Share
                  </a>
                 </a>
                </div>
                <div class="g-plus" data-action="share" data-href="http://taxitube.io/scala.php"></div>
              </div>
            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="ios">
              ...
              <div class="careers-share-button" >
                <div class="fb-share-button" style="vertical-align:none !important" data-href="http://taxitube.io/ios.php" data-layout="button"></div>
                <div class="twitter-share-button">
                  <a onClick="window.open('http://twitter.com/intent/tweet?status=<?php echo $twitterTitle;?>', 'sharer', 'toolbar=0,status=0,width=548,height=325');" target="_parent" href="javascript: void(0)">
                    <i class="fa fa-twitter"></i>&nbsp;Share
                  </a>
                ...
                <div class="g-plus" data-action="share" data-href="http://taxitube.io/ios.php"></div>
              </div>
            </div>
            ...
            <div class="careers-share-button" >
              <div class="fb-share-button" style="vertical-align:none !important" data-href="http://taxitube.io/design.php" data-layout="button"></div>
              <div class="twitter-share-button">
                <a onClick="window.open('http://twitter.com/intent/tweet?status=<?php echo $twitterTitle;?>', 'sharer', 'toolbar=0,status=0,width=548,height=325');" target="_parent" href="javascript: void(0)">
                  <i class="fa fa-twitter"></i>&nbsp;Share
                </a>
              ...
              <div class="g-plus" data-action="share" data-href="http://taxitube.io/design.php"></div>
            </div>
          </div>
        </div>
      </div>
